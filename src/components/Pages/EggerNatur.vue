<template>
    <div class="egger--card">
      ...
      <img src="../../assets/egger_uvecano/divljihrastnatur.jpg" alt="DIVLJI HRAST NATUR">
      <div class="egger--card-description">
        <h1>EGGER-DIVLJI HRAST NATUR</h1>
  ...
  export default {
    ...
    data() {
      ...
      return {
        ...
        lineItems: [
          {
            price: 'price_1NkCWQAZiXL1qk5NtueeJkcY', // The id of the one-time price you created in your Stripe dashboard
            quantity: 1, // Initialize quantity to 1
          }
        ],
