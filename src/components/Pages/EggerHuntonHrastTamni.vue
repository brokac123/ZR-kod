<template>
    <div class="egger--card">
      ...
      <img src="../../assets/egger_uvecano/eggerhuntonhrasttamni.jpg" alt="EGGER-HUNTON HRAST TAMNI">
      <div class="egger--card-description">
        <h1>EGGER-HUNTON HRAST TAMNI</h1>
  ...
  export default {
    ...
    data() {
      ...
      return {
        ...
        lineItems: [
          {
            price: 'price_1Nkrn9AZiXL1qk5NdYQU8k4Q', // The id of the one-time price you created in your Stripe dashboard
            quantity: 1, // Initialize quantity to 1
          }
        ],
