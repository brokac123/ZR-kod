<template>
    <div class="egger--card">
      ...
      <img src="../../assets/egger_uvecano/eggerwhitewood.jpg" alt="EGGER WHITE WOOD">
      <div class="egger--card-description">
        <h1>EGGER - WHITE WOOD</h1>
  ...
  export default {
    ...
    data() {
      ...
      return {
        ...
        lineItems: [
          {
            price: 'price_1Nkri9AZiXL1qk5N03mvNeTk', // The id of the one-time price you created in your Stripe dashboard
            quantity: 1, // Initialize quantity to 1
          }
        ],
