<template>
    <div class="egger--card">
      ...
      <img src="../../assets/egger_uvecano/eggercesena.jpg" alt="EGGER-CESENA">
  ...
  export default {
    ...
    data() {
      ...
      return {
        ...
        lineItems: [
          {
            price: 'price_1NkrehAZiXL1qk5NlTmJXhcW', // The id of the one-time price you created in your Stripe dashboard
            quantity: 1, // Initialize quantity to 1
          }
        ],
