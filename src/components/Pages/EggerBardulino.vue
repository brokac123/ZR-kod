<template>
    <div class="egger--card">
      ...
      <img src="../../assets/egger_uvecano/eggerbardulinohrast.jpg" alt="egger bardulino">
      <div class="egger--card-description">
        <h1>EGGER - BARDULINO HRAST</h1>
  ...
  export default {
    ...
    data() {
      ...
      return {
        ...
        lineItems: [
          {
            price: 'price_1NkCYuAZiXL1qk5NJOVvHAKo', // The id of the one-time price you created in your Stripe dashboard
            quantity: 1, // Initialize quantity to 1
          }
        ],
