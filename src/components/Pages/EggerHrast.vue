<template>
    <div class="egger--card">
      ...
      <img src="../../assets/egger_uvecano/eggerarcanihrast.jpg" alt="EGGER-ARCANI HRAST">
      <div class="egger--card-description">
        <h1>EGGER - ARCANI HRAST</h1>
  ...
  export default {
    ...
    data() {
      ...
      return {
        ...
        lineItems: [
          {
            price: 'price_1Nk7hkAZiXL1qk5NGkeqGPkc', // The id of the one-time price you created in your Stripe dashboard
            quantity: 1, // Initialize quantity to 1
          }
        ],
